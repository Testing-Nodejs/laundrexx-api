  ...
  try {
    ...
    if (result4.recordsets[0].length > 0) {
      ...
      var result = await pool
        ...
        .input("SERVICE_CATEGORY_DESCRIPTION", obj.SERVICE_CATEGORY_DESCRIPTION)
        .input("SERVICE_CATEGORY_ORDER_COUNT", obj.SERVICE_CATEGORY_ORDER_COUNT)
        .query(
          `INSERT INTO SERVICE_CATEGORY(SERVICE_CATEGORY_NAME,SERVICE_CATEGORY_CODE,SERVICE_CATEGORY_HSN,SERVICE_CATEGORY_CGST,SERVICE_CATEGORY_SGST,SERVICE_CATEGORY_ORDER_COUNT,SERVICE_CATEGORY_DESCRIPTION) VALUES (@SERVICE_CATEGORY_NAME,@SERVICE_CATEGORY_CODE,@SERVICE_CATEGORY_HSN,@SERVICE_CATEGORY_CGST,@SERVICE_CATEGORY_SGST,@SERVICE_CATEGORY_ORDER_COUNT,@SERVICE_CATEGORY_DESCRIPTION)`
        );
    ...
    if (result4.recordsets[0].length > 0) {
      ...
      if (result.rowsAffected > 0) {
        ...
        if (result1.recordsets[0].length > 0) {
          for (var i = 0; i < obj.ServiceTypeCategory.length; i++) {
            var result2 = await pool
              ...
              .input(
                "TYPE_CATEGORIES_CATEGORY_FKID",
                obj.ServiceTypeCategory[i].value
              )
              .query(
